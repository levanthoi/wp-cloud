...
function custom_woocommerce_product_searchform($form)
{
	ob_start();
	wc_get_template('product-searchform/custom-product-searchform.php');
	return ob_get_clean();
}
add_filter('get_product_search_form', 'custom_woocommerce_product_searchform');

function enqueue_custom_search_scripts()
{
	wp_enqueue_script('google-cloud-speech', 'https://cdn.jsdelivr.net/npm/@google-cloud/speech@6.6.0/build/src/index.min.js', array(), null, true);
	wp_enqueue_script('custom-search-script', get_template_directory_uri() . '/assets/js/custom-search.js', array('jquery'), null, true);
}
...
function electronic_supermarket_admin_enqueue_scripts()
{
	...
	wp_localize_script(
		'electronic-supermarket-admin-script',
		'electronic_supermarket_ajax_object',
				...
				<div class="electronic-supermarket-theme-notice-content">
					<h2 class="electronic-supermarket-notice-h2">
						...
						printf(
							...
							esc_html__('Welcome! Thank you for choosing %1$s!', 'electronic-supermarket'),
