...
//sale position
$electronic_supermarket_scroll_position = get_theme_mod( 'electronic_supermarket_sale_tag_position','right');
if($electronic_supermarket_scroll_position == 'right'){
$electronic_supermarket_tp_theme_css .='.woocommerce ul.products li.product .onsale{';
    $electronic_supermarket_tp_theme_css .='right: 25px !important;';
$electronic_supermarket_tp_theme_css .='}';
}else if($electronic_supermarket_scroll_position == 'left'){
$electronic_supermarket_tp_theme_css .='.woocommerce ul.products li.product .onsale{';
    $electronic_supermarket_tp_theme_css .='left: 25px !important;';
$electronic_supermarket_tp_theme_css .='}';
}